...
HD_PWD='E:/Homeworks/cpupip31/project_1/project_1.runs/dmem1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmem1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dmem1.tcl
